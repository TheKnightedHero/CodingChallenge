...
public class DatabaseParser {
	...
	public static void createNewDatabase(String fileName) {
		...
		// String url = "jdbc:sqlite:D:/Programs/GitHub/CodingChallenge/Database/" +
		// fileName;
	...
	public void readFromFile() {
		try {
			...
			// subtract 1 from numOfRecords and numOfGoodRecords since initial pass is
	...
	public void writeToDatabase()
	{
		...
		try 
		{
			...
			if(conn != null ) 
			{
				...
				{
					//Originally was supposed to loop through, but had trouble getting my concatenated strings to INSERT correctly
					String sql ="INSERT INTO csvData(A,B,C,D,E,F,G,H,I,J) VALUES(" + rowData.get(0) + ","
																					+ rowData.get(1) + ","
																					+ rowData.get(2) + ","
																					+ rowData.get(3) + ","
																					+ rowData.get(4) + ","
